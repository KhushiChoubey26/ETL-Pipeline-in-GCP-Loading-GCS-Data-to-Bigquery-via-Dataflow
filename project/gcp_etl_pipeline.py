...
def create_dataset():
    ...
    #Dataset-id variable
    dataset_id = "khushi-26.airbnb_ds_new"
...
pipeline_options = PipelineOptions(
    ...
    project='khushi-26',
    temp_location='gs://etlpipeline/tmp/',
    staging_location='gs://etlpipeline/staging',
...
gcs_bucket = 'etlpipeline'
csv_file_path = 'airbnb_data.csv'
gcs_path = f'gs://{gcs_bucket}/{csv_file_path}'

# Define variables for Data write to BigQuery
output_table_spec = 'khushi-26:airbnb_ds_new.airbnb_tb_new'
gcs_temp_location = 'gs://etlpipeline/bigquery_temp/'
...
view_id = "khushi-26.airbnb_ds_new.airbnb_analysis_vw_new"
